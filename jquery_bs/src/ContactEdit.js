...
const template_str=`
<div id="modal1_cantactEdit" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" style="max-width:700px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">编辑仪器信息</h5>
...
class ContactEdit2New{
  ...
  show=()=>{
        ...
        $('#modal1_cantactEdit').modal(options)
  }  
  ...
  open2=(idx)=>{
    ...
    var val1=this.old.detail;//RichTextEditor.createValueFromString(this.old.detail,"html");
    // console.log(val1);
