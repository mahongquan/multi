...
class Items extends Component {
    renderCard=(start,lian)=>{
      return `<div style="position:relative;width:210mm;height:148mm;border:solid 1px;padding-left:100px;padding-right:100px">
      <p style="margin-top:140px;margin-left:100px;font-size:20px">
  ...
  componentDidMount=()=>{
    ...
    $("#id_start").change(this.onChange);
    $("#id_num").change(this.onChange_num);
    $("#id_year").change(this.onChange_year);
  ...
  render=()=>{
    return (`
<div>
  <div style="display:flex;justify-content:space-between" class="only_screen">
   <div>
