...
var searchbarAutocomplete = require('./searchbarAutocomplete.js');
var urlParser = require('../util/urlParser.js');
var { debounce } = require('../func');
    ...
    if (pluginName === 'fullTextPlaces') {
      ...
      if (previousPlacesResults.text === text) {
        results = results.filter(
          r => previousPlacesResults.results.indexOf(r.url) === -1
        );
      }
    }
