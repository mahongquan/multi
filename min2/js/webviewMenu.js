    ...
    if (link) {
      ...
      menuSections.push([
        new MenuItem({
          label: l('saveImageAs'),
          click: function() {
            electron.remote.getCurrentWebContents().downloadURL(image);
          },
        }),
      ]);
    }
      ...
      var textActions = [
        new MenuItem({
          ...
          click: function() {
            ...
            myglobal.webviews.get(newTab).focus();
          },
        }),
      ];
    ...
    if (data.editFlags && data.editFlags.canPaste) {
      clipboardActions.push(
        new MenuItem({
          label: l('paste'),
          click: function() {
            myglobal.webviews.get(tabs.getSelected()).paste();
          },
        })
      );
    }
...
myglobal.webviews.bindEvent('context-menu', function(e, data) {
