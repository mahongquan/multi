...
const browserPage = 'file://' + __dirname + '/src/index.html'
...
function createAppMenu () {
    ...
    template.unshift({
      ...
      submenu: [
        ...
        },
        {
          ...
          accelerator: 'CmdOrCtrl+,',
          click: function (item, window) {
            sendIPCToWindow(window, 'settings', {})
          }
        },
        {
          label: 'Services',
  ...
  console.log("createAppMenu finish");
}
...
ipc.on('getCapture', function (e, data) {
  if(!viewMap[data.id].webContents) return;//ma
